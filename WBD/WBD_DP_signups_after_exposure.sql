...
count(distinct case when dashpass_signup = 1 then subscription_id end) as signups
from proddb.katez.wbd_first_eligible_cohort a
left join proddb.katez.dp_signups_0126 b
 on a.consumer_id=b.consumer_id
 and start_time::date between DATEADD(day,-30,first_eligible_dt) and DATEADD(day,1080,first_eligible_dt)
